...
use crate::instructions::{
    ...
    create_recurring_delegation, create_up_to_delegation, delete_plan, emit_event, initialize_subscription_authority,
    ...
    transfer_subscription, transfer_up_to, update_plan, SubscriptionsInstruction,
};
...
pub fn process_instruction(
    ...
    match instruction {
        ...
        SubscriptionsInstruction::CreateUpToDelegation(data) => create_up_to_delegation::process(accounts, &data),
        SubscriptionsInstruction::TransferUpTo(data) => transfer_up_to::process(accounts, &data),
