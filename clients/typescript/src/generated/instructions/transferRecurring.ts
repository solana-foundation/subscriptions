...
export function getTransferRecurringDiscriminatorBytes() {
...
> {
  ...
  return Object.freeze({
    ...
    data: getTransferRecurringInstructionDataEncoder().encode(
      args as TransferRecurringInstructionDataArgs,
    ),
    programAddress,
