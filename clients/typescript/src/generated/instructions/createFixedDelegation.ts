...
export function getCreateFixedDelegationDiscriminatorBytes() {
...
> {
  ...
  return Object.freeze({
    ...
    data: getCreateFixedDelegationInstructionDataEncoder().encode(
      args as CreateFixedDelegationInstructionDataArgs,
    ),
    programAddress,
...
>(
  ...
  return {
    ...
    data: getCreateFixedDelegationInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
