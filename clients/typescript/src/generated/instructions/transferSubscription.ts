...
export function getTransferSubscriptionDiscriminatorBytes() {
  ...
  InstructionWithAccounts<
    [
      TAccountSubscriptionPda extends string
        ? WritableAccount<TAccountSubscriptionPda>
        : TAccountSubscriptionPda,
      TAccountPlanPda extends string
        ? ReadonlyAccount<TAccountPlanPda>
        : TAccountPlanPda,
...
> {
  ...
  return Object.freeze({
    ...
    data: getTransferSubscriptionInstructionDataEncoder().encode(
      args as TransferSubscriptionInstructionDataArgs,
    ),
    programAddress,
...
>(
  ...
  return {
    ...
    data: getTransferSubscriptionInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
