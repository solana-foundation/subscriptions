...
export function getTransferFixedDiscriminatorBytes() {
  ...
  InstructionWithAccounts<
    [
      TAccountDelegationPda extends string
        ? WritableAccount<TAccountDelegationPda>
      ...
      TAccountDelegatorAta extends string
        ? WritableAccount<TAccountDelegatorAta>
      ...
      TAccountDelegatee extends string
        ? ReadonlySignerAccount<TAccountDelegatee> &
            AccountSignerMeta<TAccountDelegatee>
        : TAccountDelegatee,
...
> {
  ...
  return Object.freeze({
    ...
    data: getTransferFixedInstructionDataEncoder().encode(
      args as TransferFixedInstructionDataArgs,
    ),
    programAddress,
...
export function parseTransferFixedInstruction<
