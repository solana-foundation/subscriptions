...
The merchant or a whitelisted puller signs collection. The receiver token account must match the plan's destination rules when the plan uses a destination allowlist.
